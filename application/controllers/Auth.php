...
class Auth extends CI_Controller
{
	...
	private function _sendEmail($token, $type)
	{
		...
		if ($type=='verify') {
			...
			$this->email->message('Click this link to reset your CI APP password account : <a href="'.base_url().'auth/resetpassword?email='.$this->input->post('email').'&token='.urlencode($token). '">Reset Password</a>');
		}
